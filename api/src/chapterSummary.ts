...
// chapter absent here is unreachable in the UI. Shape mirrors the per-chapter
// object chapters.ts merges from its two batched summary queries (counts +
// validation/done rollup).
...
// 2026-09-09 upstream). Always offer chapter 0 for an imported book: the
// chapter view renders an empty intro with the notes Add button, and shows any
// trashed intro card with its Restore button.
