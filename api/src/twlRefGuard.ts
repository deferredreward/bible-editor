...
// the full Hono route's dependency graph. See issue #724.
//
...
// TWL PATCH path rejected it — the ref_raw -> verse re-derivation silently
// took the range's leading verse (or ignored garbage), leaving the stored
// chapter/verse columns (which drive grouping/canonical order/export)
// diverging from what ref_raw itself says. Chapter 0 is rejected directly
// here by requiring a positive chapter (twl has no legal chapter-0 shape).
